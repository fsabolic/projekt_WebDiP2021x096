<?php
/* Smarty version 4.0.0, created on 2022-06-14 23:19:13
  from '/var/www/webdip.barka.foi.hr/2021_projekti/WebDiP2021x096/templates/prihvaceni_zahtjevi.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.0.0',
  'unifunc' => 'content_62a8fb5176b3f7_86916825',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4ab57aa4d9a69282eec7c5c55aa28f68bfc4674d' => 
    array (
      0 => '/var/www/webdip.barka.foi.hr/2021_projekti/WebDiP2021x096/templates/prihvaceni_zahtjevi.tpl',
      1 => 1655238996,
      2 => 'file',
    ),
  ),
...
function content_62a8fb5176b3f7_86916825 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="opcenito--tablica-wrapper-wrapper">
    <div class="opcenito--tablica-wrapper">
        <h2 class="opcenito--tablica--naslov-tablice">Prihvaćeni zahtjevi</h2>
        <div class="opcenito--tablica-zaglavlje">
            <div class="button-wrapper"><button class="opcenito--vazan-gumb" id="pregledaj" name="pregledaj">Pregledaj zaprimljene zahtjeve</button></div>
            <div class="opcenito--tablica-zaglavlje-pretrazivanje">
                ...
                <select id="atribut_za_pretrazivanje">
                    ...
                    <option id="k1.ime_prezime" name="k1.ime_prezime" value="k1.ime_prezime">Tuženik</option>
                    <option id="k2.ime_prezime" name="k2.ime_prezime" value="k2.ime_prezime">Tužitelj</option>
                    <option id="o.obrana_id" name="o.obrana_id" value="o.obrana_id">ID obrane</option>
                    <option id="o.argumenti_obrane" name="o.argumenti_obrane" value="o.argumenti_obrane">Argumenti obrane</option>
                </select>
            </div>
        </div>
        ...
        <table class="opcenito--tablica">
            <thead>
                <tr>
                    ...
                    <th id="azuriraj_sudski_postupak">Ažuriraj sudski postupak</th>

                    <th id="k1.ime_prezime" class="opcenito--tablica-zaglavlje-hover">Tuženik</th>

                    <th id="k2.ime_prezime" class="opcenito--tablica-zaglavlje-hover">Tužitelj</th>

                    <th id="o.obrana_id" class="opcenito--tablica-zaglavlje-hover">ID obrane</th>

                    <th id="o.argumenti_obrane" class="opcenito--tablica-zaglavlje-hover">Argumenti obrane</th>

                    <th id="dodaj_azuriraj">Dodaj/Ažuriraj obranu</th>
                    
                    <th id="h--obrisi">Obriši obranu</th>
                </tr>    
            </thead>
            <tbody>
...
<input id="broj_stranice" name="broj_stranice" value="0" hidden><?php }
}
