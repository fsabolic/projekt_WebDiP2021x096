...
$baza = new Baza();
$baza->spojiDB();
$broj_redova = count($baza->pravno_savjetovanje_pitanje_dohvati_sva_pitanja_za_odvjetnika($korisnik_id, 999999999, 0, $atribut_za_sortiranje, $smjer_sortiranja, $atribut_za_pretrazivanje, $vrijednost_za_pretrazivanje));
...
$tablica = $baza->pravno_savjetovanje_pitanje_dohvati_sva_pitanja_za_odvjetnika($korisnik_id, $limit, $offset, $atribut_za_sortiranje, $smjer_sortiranja, $atribut_za_pretrazivanje, $vrijednost_za_pretrazivanje);
$baza->zatvoriDB();
