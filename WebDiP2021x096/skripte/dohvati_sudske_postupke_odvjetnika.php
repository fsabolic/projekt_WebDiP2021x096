...
$baza = new Baza();
$baza->spojiDB();
$broj_redova = count($baza->sudski_postupak_dohvati_napravljene($korisnik_id, 999999999, 0,$atribut_za_sortiranje, $smjer_sortiranja, $atribut_za_pretrazivanje, $vrijednost_za_pretrazivanje));
...
$tablica = $baza->sudski_postupak_dohvati_napravljene($korisnik_id, $limit, $offset, $atribut_za_sortiranje, $smjer_sortiranja, $atribut_za_pretrazivanje, $vrijednost_za_pretrazivanje);
$baza->zatvoriDB();
