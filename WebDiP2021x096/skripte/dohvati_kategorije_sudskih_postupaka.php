...
$baza = new Baza();
$baza->spojiDB();
$broj_redova = count($baza->kategorija_sudskog_postupka_dohvati_sve(999999999, 0, $atribut_za_sortiranje, $smjer_sortiranja, $atribut_za_pretrazivanje, $vrijednost_za_pretrazivanje));
...
$tablica = $baza->kategorija_sudskog_postupka_dohvati_sve($limit, $offset, $atribut_za_sortiranje, $smjer_sortiranja, $atribut_za_pretrazivanje, $vrijednost_za_pretrazivanje);
$baza->zatvoriDB();
