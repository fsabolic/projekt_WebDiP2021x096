...
$baza = new Baza();
$baza->spojiDB();
$broj_redova = count($baza->korisnik_dohvati_za_blokiranje(999999999, 0, $atribut_za_sortiranje, $smjer_sortiranja, $atribut_za_pretrazivanje, $vrijednost_za_pretrazivanje));
...
$tablica = $baza->korisnik_dohvati_za_blokiranje($limit, $offset, $atribut_za_sortiranje, $smjer_sortiranja, $atribut_za_pretrazivanje, $vrijednost_za_pretrazivanje);
$baza->zatvoriDB();
