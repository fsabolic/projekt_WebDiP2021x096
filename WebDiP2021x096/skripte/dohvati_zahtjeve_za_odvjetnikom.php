...
$baza = new Baza();
$baza->spojiDB();
$broj_redova = count($baza->zahtjev_za_odvjetnikom_dohvati_korisnikove($korisnik_id, 999999999, 0, $atribut_za_sortiranje, $smjer_sortiranja, $atribut_za_pretrazivanje, $vrijednost_za_pretrazivanje));
...
$tablica = $baza->zahtjev_za_odvjetnikom_dohvati_korisnikove($korisnik_id, $limit, $offset, $atribut_za_sortiranje, $smjer_sortiranja, $atribut_za_pretrazivanje, $vrijednost_za_pretrazivanje);
$baza->zatvoriDB();
