...
if (count($greske) == 0) {
    ...
    $konfiguracija->postaviBrojSudskihPostupaka($konfiguracijske_postavke['broj_sudskih_postupaka']);
    $konfiguracija->postaviBrojZahtjeva($konfiguracijske_postavke['broj_zahtjeva']);
    $konfiguracija->postaviBrojOdgovora($konfiguracijske_postavke['broj_odgovora']);
